        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="text-center md:text-left">
            <p className="text-soft-ivory/70 font-medium">
               <span className="text-luxury-gold"></span> by Divya Venkatesan
            </p>
          </div>

          <div className="flex items-center gap-4">
            <a href="https://github.com" target="_blank" rel="noreferrer" className="text-soft-ivory/70 hover:text-emerald-400 transition-colors">
              <FaGithub size={20} />
            </a>
            <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="text-soft-ivory/70 hover:text-emerald-400 transition-colors">
              <FaLinkedin size={20} />
            </a>
            <button 
              onClick={scrollToTop}
